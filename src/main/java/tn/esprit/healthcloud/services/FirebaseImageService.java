...
public class FirebaseImageService implements IImageService {
    ...
    public String download(String fileName) throws IOException {
        ...
        String destFilePath = "C:/Users/HP/Téléchargements/" + destFileName;                                    // to set destination file path
        
        ////////////////////////////////   Download  ////////////////////////////////////////////////////////////////////////
        Credentials credentials = GoogleCredentials.fromStream(new FileInputStream("C:/Users/HP/IdeaProjects/healthCloud/src/main/resources/healthcloudproject-70ea7-firebase-adminsdk-6xj2h-92f9e0e28d.json"));
